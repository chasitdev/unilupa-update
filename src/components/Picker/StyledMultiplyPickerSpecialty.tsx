...
import SpecialityModalSelection from '../Auth/SpecialityModalSelection.tsx';
...
const StyledMultiplyPickerSpecialty = forwardRef<unknown, Props>(
  (props, ref) => {
    ...
    return (
      <View
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          style={styles.picker}>
          <TextCustom fontSize={14} lineHeight={18} style={styles.text}>
            {getNames(values) || 'Виберіть значення'}
          </TextCustom>
        </TouchableOpacity>

        <SpecialityModalSelection
          open={open}
          onClose={() => {
            setOpen(false);
          }}
...
export default StyledMultiplyPickerSpecialty;
